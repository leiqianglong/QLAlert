...
@interface ExhibitionControllerDetail ()

@end

@implementation ExhibitionControllerDetail
...
-(void)touchesBegan:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event{
    [self.needcrypto resignFirstResponder];
    [self.showcrypto resignFirstResponder];
    [self.decrypt resignFirstResponder];
}
